document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Score:157/160\n- Слайдер в секции Welcome +24\n- Слайдер в секции Video => \nесли видео с YouTube проигрывается, клик по кнопке Pause останавливает его проигрывание. Также проигрывание видео останавливается, если кликнуть по другому слайду или кнопке Play в центре другого слайда. В указанной ситуации другое видео должно запуститься, а текущее остановиться. Невозможно проигрывание нескольких YouTube видео одновременно (частично выполнил) +1,\nесли внутри слайда проигрывается видео с YouTube, клик по стрелке перелистывания слайдов или клик по буллету останавливает проигрывание видео - 0, остальные пункты выполнил === +17\n- Кастомный видеоплеер +36\n- Слайдер сравнения изображений в секции Explore +10\n- Анимации прокрутки изображений в секции Gallery +8\n- Калькулятор продажи билетов в Tickets +10\n- Калькулятор продажи билетов в форме продажи +14\n- Валидация формы +16\n- Интерактивная карта в секции Contacts +12\n- Дополнительный функционал - слайдер изображений в секции Tickets, визуальное представление скорости воспроизведения в видеоплеере (проявляется в виде цифр), плавное проявление инвалидных полей при попытке отправить форму +10\nPS: некоторые введённые данные сохраняются на стороне LocalStorage\nПриятной проверки.');
});
